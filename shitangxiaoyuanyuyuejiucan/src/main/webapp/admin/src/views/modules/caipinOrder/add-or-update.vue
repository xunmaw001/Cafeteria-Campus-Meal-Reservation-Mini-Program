    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="取餐号" prop="caipinOrderUuidNumber">
                       <el-input v-model="ruleForm.caipinOrderUuidNumber"
                                 placeholder="取餐号" clearable  :readonly="ro.caipinOrderUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="取餐号" prop="caipinOrderUuidNumber">
                           <el-input v-model="ruleForm.caipinOrderUuidNumber"
